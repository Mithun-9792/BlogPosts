import { createElement, forwardRef as forwardRef$1, useRef as useRef$1, useState as useState$1, useLayoutEffect as useLayoutEffect$1, useCallback as useCallback$1, useImperativeHandle as useImperativeHandle$1 } from 'react';
...
var forwardRef = forwardRef$1, useRef = useRef$1, useState = useState$1, useLayoutEffect = useLayoutEffect$1, useCallback = useCallback$1, useImperativeHandle = useImperativeHandle$1;
var Editor = forwardRef(function (props, ref) {
    ...
    return (createElement("div", __assign({ ref: elRef, contentEditable: true, "data-placeholder": placeholder, className: [styles.editor, className].filter(Boolean).join(' '), onFocus: handleFocus, onBlur: handleBlur, onDrop: handleDrop, onPaste: handlePaste, onInput: handleInput }, restProps)));
});
